...
def main():
    ...
    st.header("Chat with Gemini AI with Custom Data for your uploaded Document")
    user_question = st.text_input("Ask a question about your Data:")

    with st.sidebar:
        st.subheader("Your documents")
        pdf_docs = st.file_uploader(
            "Upload your Documents here in PDF format and click on 'Upload'", accept_multiple_files=True, type=['pdf'])
